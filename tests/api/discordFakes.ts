...
export function createBaseFakeBot(overrides: FakeBotOverrides = {}): DiscordBotClient {
  ...
  return {
    ...
    startThreadFromMessage: unused('startThreadFromMessage') as DiscordBotClient['startThreadFromMessage'],
    addThreadMember: unused('addThreadMember') as DiscordBotClient['addThreadMember'],
    lockThread: unused('lockThread') as DiscordBotClient['lockThread'],
