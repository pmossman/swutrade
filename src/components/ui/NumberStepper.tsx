  ...
  return (
    <div className="inline-flex items-center gap-1 shrink-0">
      <button
        ...
        className={`${btnSize} hit-area-44 rounded bg-space-800 border border-space-700 text-gray-400 hover:text-gold hover:border-gold/40 disabled:opacity-50 disabled:hover:text-gray-400 disabled:hover:border-space-700 transition-colors flex items-center justify-center font-bold`}
      >
        −
      </button>
      <input
